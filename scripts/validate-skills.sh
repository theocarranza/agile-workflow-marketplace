...
# Root skills/ is the discovery surface for skills.sh and openskills.cc; symlinks to agile-backlog-toolkit/skills/.
SKILLS_DIR="$ROOT/skills"
if [[ ! -d "$SKILLS_DIR" ]]; then
  SKILLS_DIR="$ROOT/agile-backlog-toolkit/skills"
fi
FAILED=0
